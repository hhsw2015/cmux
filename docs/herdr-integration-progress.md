...
| **E2d (split / drag / swap)** | Outbound for the remaining mutation kinds: bonsplit splitPane / divider drag / tab swap → matching RPCs with optimistic apply + reconcile from `LayoutChanged`. | pending |
