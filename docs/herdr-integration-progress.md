...
| **E2e-2 (structural)** | Inbound for structural changes (remote split / close / move): apply diffs to bonsplit + bind/unbind in registry + wire/teardown terminals. | pending |
