...
struct VerticalTabsSidebar: View {
    ...
    var body: some View {
        ...
        ZStack(alignment: .bottomLeading) {
            // Extension sidebar (upstream) takes the full slot when
            // selected. Otherwise fork's herdr-remote section sits
            // below the workspace list when there are remote hosts.
